...
//       ) : (
//         <>
//           <div className="overflow-y-auto max-h-[70vh] rounded-lg shadow-md border">
...
//                   <th className="p-3 text-left">Job Interest</th>
...
//                       </td>
//                       <td className="p-3">{tech.jobInterest || "N/A"}</td>
//                       <td className="p-3">
...
//                 breakClassName={"px-3 py-1 border rounded cursor-default"}
//               />
//             </div>
//           )}
//           {error && (
